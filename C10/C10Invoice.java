...
public class C10Invoice implements C10Payable{
    ...
    // construtor
    public C10Invoice(String partNumber, String partDescription, int quantity,
    double pricePerItem)
    {
    ...
    public String getPartNumber(){return partNumber;} // deve validar
