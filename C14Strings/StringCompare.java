...
public class StringCompare {
    public static void main(String[] args) {
        ...
        if(s3.equalsIgnoreCase(s4))
            ...
            System.out.printf("%s doesn't equals %s with case ignored", s3, s4);
        ...
        if(s3.regionMatches(0, s4, 0, 5))
            ...
            System.out.println("First 5 characters of s3 and s4 doesn't match");
        ...
        if(s3.regionMatches(true, 0, s4, 0, 5))
            ...
            System.out.println(
                "First 5 characters of s3 and s4 doesn't match");
