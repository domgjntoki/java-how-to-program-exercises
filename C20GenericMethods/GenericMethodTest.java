package C20GenericMethods;// Fig. 20.3: GenericMethodTest.java
...
public class GenericMethodTest {
   public static void main(String[] args) {
       ...
       String[] stringArray = {"Hello,", "World!", "The", "Default", "Program", "Of", "Every", "Programming","Language"};
   ...
   public static void printArray(String[] inputArray){
       ...
       for(int i = 0; i < inputArray.length; i++){
           ...
           System.out.print(s);
           int spaces = (maxlenght + 3) - s.length();
